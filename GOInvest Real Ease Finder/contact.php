...
<div id="page-wrapper">
    <div class="row"> 
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">Nairobi</span> <br>
										<span class="text-white">Moi Avenue Street, Rafiki Plaza</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+254 98884016</span>
                                ...
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
										...
										<span class="d-table text-white">goinvest@gmail.com</span>
        ...
        <!--	Map -->
		<iframe src="https://www.bing.com/search?q=nairobi+map+link&cvid=549141af8842453392b1e21bee582225&gs_lcrp=EgZjaHJvbWUqBggBEEUYOzIGCAAQRRg7MgYIARBFGDsyBggCEEUYOTIGCAMQABhAMgYIBBAAGEAyBggFEAAYQDIGCAYQABhAMgYIBxAAGEAyBggIEEUYPdIBCDMxNjRqMGo5qAIAsAIA&FORM=ANAB01&PC=U531"></iframe>
		<!--	Map -->
