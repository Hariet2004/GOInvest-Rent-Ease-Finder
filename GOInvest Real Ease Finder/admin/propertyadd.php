...
if(isset($_POST['add']))
{
	...
	$sql="INSERT INTO property (title,pcontent,type,bhk,stype,bedroom,bathroom,balcony,kitchen,hall,floor,size,price,location,city,state,Malls,Placeofwork,feature,pimage,pimage1,pimage2,pimage3,pimage4,uid,status,mapimage,topmapimage,groundmapimage,totalfloor,isFeatured)
	VALUES('$title','$content','$ptype','$bhk','$stype','$bed','$bath','$balc','$kitc','$hall','$floor','$asize','$price',
	'$loc','$city','$state','$MallS','$Placeofwork','$feature','$aimage','$aimage1','$aimage2','$aimage3','$aimage4','$uid','$status','$fimage','$fimage1','$fimage2','$totalfloor','$isFeatured')";
									...
									<?php echo $msg; ?>
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="ptype">
															...
															<option value="1 bedroom">1Bedroom</option>
										...
										<div class="row">
											...
											<div class="col-xl-6">
												...
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Mall</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="Malls" required placeholder="Enter Mall">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Place Of Work</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="Placeofwork" required placeholder="Enter Place of work">
													</div>
												</div>
											</div>
										</div>
