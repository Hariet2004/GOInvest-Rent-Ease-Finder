...
<div id="page-wrapper">
    ...
    <form method="post" action="specifications.php">
        <center> 
                ...
                <div class="row">
                    <div class="col-md-6">
                        <h6 class="page-name float-left text-white text-uppercase mt-1 mb-0">Filter Property nearest Shopping Center or Mall</h6>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="col-md-8 col-lg-6">
                                        ...
                                        <select id="MallsSelect" class="form-control" name="Malls" required>
                                            <option value="" selected disabled>Select Mall</option>
                                            <option value="Gardencity">Garden City</option>
                                            <option value="T-mall">T-mall</option>
                                            <option value="Jujacity">Juja City</option>
                                            <option value="Mountainmall">Mountain Mall</option>
                                            <option value="TRM">TRM</option>
                                            <option value="Chinasquare">China Square</option>
