...
<div id="page-wrapper">
    ...
    <form method="post" action="placeofworkproperty.php">
        <center> 
              <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <h6 class="page-name float-left text-white text-uppercase mt-1 mb-0">Filter Property by place of work</h6>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="col-md-8 col-lg-6">
                                        ...
                                        <select id="PlaceofworkSelect" class="form-control" name="Placeofwork" required>
                                            <option value="" selected disabled>Place of work</option>
					...
					<div class="col-lg-8">
                        <div class="row">
							...
							if(isset($_REQUEST['filter']))
							{
                                ...
                                $Malls=$_REQUEST['Malls'];
                        
								
								$sql="SELECT property.*, user.uname FROM `property`,`user` WHERE property.uid=user.uid and Malls='{$Malls}'";
